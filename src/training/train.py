...
if __name__ == "__main__":
    ...
    trainer = Trainer(model=model, dataset=dataset, batch_size=128, learning_rate=0.001, loss_fn_name='mse')
    # trainer._load_snapshot('checkpoints/model_epoch_100.pth')
    # model.load_state_dict(
    #     torch.load('/home/abughdaryan/diffusion-journey/checkpoints/model_epoch_140.pth')
    #     )
